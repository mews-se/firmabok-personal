 ...
 *
 * 2012 "Avräkning för skatter och avgifter" was added on the strength
 * of the swedish-year-end-closing skill alone. The primary-source check
 * (bas.se, BAS 2026 v2) shows the official chart has no 2012: the block
...
describe('enskild firma equity accounts (20xx)', () => {
  ...
  it('does not carry 2012: not in official BAS, verified against bas.se', () => {
