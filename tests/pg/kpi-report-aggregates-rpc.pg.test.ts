 ...
 *     reversed, minus the undone year-end chain; since 20260903160000: a reversed original and its storno cancel within the year so
...
async function seedFullScenario() {
  ...
  // monthly section shares tb_ex_year_end's entry set)
  await insertJournalEntry({
...
describe('get_kpi_report_aggregates RPC', () => {
  ...
  it('monthly counts posted and reversed originals, 8999 excluded, class 8 sign-split per line', async () => {
    ...
    // months stopped summing to the year total.
